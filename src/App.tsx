...
const teamMembers = [
  {
    ...
    bio: "Jose Jorge (JJ) Figueroa is a real estate developer, broker, and financier with over two decades of industry experience. He is Co-Owner and Managing Director of Alcazar Development Group (ADG), where he leads acquisitions, financial modeling, capital structuring, and overall development strategy for the firm's multifamily portfolio throughout Florida. ADG specializes in the development and ownership of garden-style multifamily apartment communities focused on delivering quality housing to underserved workforce markets.\n\nMr. Figueroa is also Co-Founder of Figueroa-Heller Capital Partners (FHCP, LLC), a private mortgage lending and servicing platform that has been operational since 2011, providing asset-based financing solutions for real estate investors and developers.\n\nHe began his career in real estate in 2001 with Caribe Homes Corporation, where over eight years he contributed to the development and sales of 17 single-family home communities totaling more than 2,257 homes across South Florida. This experience provided him with a strong foundation in large-scale residential development and the delivery of attainably priced housing.",
    image: "/assets/images/website/jj-figueroa.jpg",
  },
  {
    name: "Justo L. Fernandez",
    title: "Managing Director",
    bio: "Justo L. Fernandez brings more than 40 years of extensive real estate experience encompassing deal structuring, acquisitions, development, financial modeling, and market research across both residential and commercial property types. As Managing Director and co-owner of Alcazar Development Group (ADG), he oversees pre-construction planning, project execution, and construction oversight across the firm's multifamily development pipeline, helping advance ADG's mission of delivering high-quality, attainable housing in Florida's growing workforce communities.\n\nPrior to transitioning into real estate development, Mr. Fernandez spent 30 years in the financial industry at Mercantil Commercebank, where he served as Executive Vice President and Manager of the Commercial Real Estate Division. In this role, he led the expansion of the bank's commercial real estate lending activities across Florida, New York, and Houston, managing a loan portfolio exceeding $1.6 billion. His decades of lending experience provide him with deep expertise in real estate finance, capital structuring, and underwriting, particularly for multifamily and workforce housing developments.\n\nMr. Fernandez has also been an active member of the Latin Builders Association (LBA) for more than two decades, contributing to the advancement of responsible residential development and the continued growth of South Florida's communities.",
